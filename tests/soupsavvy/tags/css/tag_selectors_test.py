...
class TestOnlyChild:
    ...
    def test_find_return_none_if_no_only_child_without_tag(self):
        """
    ...
    def test_find_return_none_if_no_only_child_with_tag(self):
        """
        Tests if find method returns None if no only child is found
    ...
    def test_find_return_first_only_child_without_tag(self):
        """
    ...
    def test_find_return_first_only_child_with_tag(self):
        """
    ...
    def test_find_all_return_empty_list_if_no_only_child_without_tag(self):
        """
    ...
    def test_find_all_return_empty_list_if_no_only_child_with_tag(self):
        """
    ...
    def test_find_all_return_all_only_children_without_tag(self):
        """
    ...
    def test_find_all_return_all_only_children_with_tag(self):
        """
        Tests if find_all method returns all only children
